  ...
  "search",
  {
    ...
    inputSchema: {
      authorityCode: z
        .string()
        .min(1)
        .describe("Authority code such as lcnaf, lcsh, fast, geonames, homosaurus, lcgft, lclang, or aat."),
  ...
  "open_authoritex",
  {
    ...
    inputSchema: {
      authorityCode: z
        ...
        .min(1)
        .optional()
        .describe("Optional authority code to preselect, such as lcsh, lcnaf, fast, geonames, homosaurus, lcgft, lclang, or aat."),
